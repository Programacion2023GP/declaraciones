...
const ComponentDeclaraciones = () => {
   ...
   const [activeStep, setActiveStep] = React.useState(isNumber(hoja) ? hoja : 10); // cambia de hoja
   const [pageAfterSituacion, setPageAfterSituacion] = React.useState(isNumber(hoja) ? hoja : 10); // funciona con hojas solo para arriba no disminuye para traer la data de la ultima situacion ->
