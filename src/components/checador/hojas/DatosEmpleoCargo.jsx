...
export const DatosEmpleoCargo = ({ data = [], testada = false, nivelOrdenGobierno, ambitoPublico,municipios=[], entidades=[], paises=[] }) => {
   ...
   return (
      <>
         ...
         <TextPdf title={"Nombre del ente público"} text={NombreEntePublico} />
         <TextPdf title={"Área de adscripción"} text={AreaAdscripcion} width={50} />
         <TextPdf title={"Empleo, cargo o comisión"} text={EmpleoCargoComision} width={50} />
         <OptionsPdf title={"¿Está contratado por honorarios?"} options={["Si", "No"]} value={ContratadoPorHonorarios == 1 ? "Si" : "No"} width={50} />
         <TextPdf title={"Empleo, cargo o comisión"} text={NivelEmpleoCargoComision} width={50} />
         <TextPdf title={"Función principal"} text={FuncionPrincipal} width={100} />

         <TextPdf title={"Fecha de toma de posesion del empleo,cargo o comisión"} text={FechaTomaConclusionPosesion} width={100} />
         <TextPdf title={"Teléfono de oficina y extensión"} text={TelefonoOficina + " EXT " + ExtensionTelefonoOficina} width={100} />
         <TextPdf title={"Domiclio del empleo, cargo o comisión"} text={EsEnMexico == 1 ? "En Mexico" : "En el extranjero"} width={100} />
         <DatosDomicilio  key={'datos empleo'} entidades={entidades} paises={paises} data={data} municipios={municipios} testada={testada}/>
