...
const Steppers = () => {
   ...
   const init = async () => {
      ...
      next ? setLoading("view") : setLoading("false");
      // setLoading(false);
   };
   useEffect(() => {
      init();
   ...
   return (
      <>
         ...
         <Ngif condition={loading == "false"}>
            <Alert severity="warning">
               <AlertTitle>No puedes crear mas declaraciones hasta finalizar la pendiente o las pendientes</AlertTitle>
               Regresa a mi declaraciones a terminar la declaración
            </Alert>
         </Ngif>
         <Ngif condition={loading == "loading"}>
            <Loading />
         </Ngif>
      </>
   );
