...
export const AvisoPrivacidad = ({ testada }) => {
   Font.register({
      family: "Open Sans",
   ...
   return (
      <Page size="A4" style={styles.page}>
         ...
         <Text style={styles.text}>
            El H. Ayuntamiento de Gómez Palacio, Durango, con domicilio en Avenida Francisco I. Madero 400 Nte, Col. Centro, Gómez Palacio, Durango, C.P. 35000, es el
            responsable del tratamiento de los datos personales que nos proporcione, los cuales serán protegidos conforme a lo dispuesto por la Ley General de
         ...
         <Text style={styles.text}>
            Para las finalidades antes señaladas, se solicitan los siguientes datos personales: nombre, fecha de nacimiento, sexo, registro federal de contribuyentes
            (RFC), clave única de registro de población (CURP), estado civil, lugar de nacimiento (país, entidad federativa, nacionalidad), domicilio actual (país,
            entidad federativa, delegación o municipio, calle, número exterior, número interior, código postal, localidad o colonia), teléfono, correo electrónico,
            información laboral, información financiera, datos e información relacionada con el patrimonio, datos curriculares, información de particulares y terceros
            relacionados con la persona servidora pública e información adicional que la persona servidora pública desee manifestar en su declaración de situación
            patrimonial.
         </Text>
         ...
         <Text style={styles.text}>
            Los datos que los servidores públicos manifiesten en cualquiera de los formatos en sus tres modalidades (inicio/modificación/conclusión), así como en los
            avisos de cambio, notas aclaratorias o actualización de intereses, se almacenarán dentro del sistema Declara Gómez y se publicitará su versión pública
            conforme al artículo 29 de la Ley General de Responsabilidades Administrativas y las Normas e Instructivo para el Llenado y Presentación del Formato de
            Declaraciones: de Situación Patrimonial y de Intereses, emitidas mediante acuerdo del Comité Coordinador del Sistema Nacional Anticorrupción.
         </Text>
         <Text break style={styles.subtitle}>
            Mecanismos, Medios y Procedimientos Disponibles para Ejercer los Derechos de Acceso, Rectificación, Cancelación u Oposición de Datos Personales (Derechos
            ARCO)
         </Text>
         <Text style={styles.text}>
            El titular de los datos personales o su representante legal, podrá ejercer su derecho de: conocer qué datos personales nos ha proporcionado, para qué los
            utilizamos y las condiciones del uso que les damos (Acceso); de solicitar la corrección de su información personal cuando esté incompleta, sea inexacta,
            inadecuada o excesiva (Rectificación); de que se elimine de nuestros registros o bases de datos cuando considere que su tratamiento contraviene lo
            dispuesto por la Ley de Protección de Datos Personales en Posesión de los Sujetos Obligados del Estado de Durango o porque dejó de ser necesaria para el
            cumplimiento de la finalidad o finalidades de dicha base (Cancelación); así como oponerse al uso de sus datos personales para fines específicos
            (Oposición).
         </Text>
         <Text style={styles.text}>
         ...
         <Text style={styles.listItem}>2. Los documentos que acrediten la identidad del titular y, en su caso, la personalidad e identidad de su representante.</Text>
         ...
         <Text style={styles.listItem}>
            4. La descripción clara y precisa de los datos personales respecto de los que se busca ejercer alguno de los derechos ARCO, salvo que se trate del derecho
            de acceso.
         </Text>
         ...
         <Text style={styles.text}>
            ...
            motivos que justifican se finalice el tratamiento de los datos personales y el daño o perjuicio que le causaría o, bien, si la oposición es parcial, debe
            indicar las finalidades específicas con las que no está de acuerdo, siempre que no sea un requisito obligatorio. La Unidad de Transparencia responderá en
            el domicilio o medio que el titular de los datos personales designe en su solicitud, en un plazo de 20 días hábiles, que puede ser ampliado por 10 días
            hábiles más previa notificación.
         </Text>
      </Page>
   );
};
